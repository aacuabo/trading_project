...
try:
    ...
    st.stop() # Stop the app if auth secrets are missing
...
if authentication_status == False:
    ...
    if not available_dates:
        ...
        # st.stop() # Don't stop the app, just show the message
        # If no dates, data fetching will fail and relevant warnings will appear.
